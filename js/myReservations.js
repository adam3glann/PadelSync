...
function fetchReservations(page) {
  ...
  try {
    ...
    var result = db.getMyBookings(user.id, reservationsPage, RESERVATIONS_PER_PAGE);
    ...
    for (var i = 0; i < bookings.length; i++) {
      ...
      html += '<div class="card">' +
        '<h3 style="color: var(--padel-blue); font-size: 1.1rem; font-style: normal;">' + b.courtId.name + '</h3>' +

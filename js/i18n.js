...
var TEXT = {
  ...
  'bookings.generateSlots': 'Generate Slots', 'bookings.generateDesc': 'Create 90-minute time blocks for all active courts on a given date.',
  'bookings.generate': 'Generate', 'bookings.generating': 'Generating...', 'bookings.scheduleTitle': 'Schedule & Equipment Orders',
  ...
  'book.free': 'free', 'book.confirmBooking': 'Confirm Booking', 'book.cancelBooking': 'Cancel Booking',
  ...
  'book.equip4': '4 Racquets & 2 Cans of Balls', 'book.noSlots': 'No slots for this date. Ask an admin to generate them.',
  ...
  'toast.courtDeleted': 'Court deleted', 'toast.booked': 'Court booked! Go smash it.',
  'toast.bookingCancelled': 'Booking cancelled', 'toast.adminCancelled': 'Booking cancelled by admin',
  'toast.selectDate': 'Please select a date', 'toast.slotsGenerated': 'Slots generated: {created} created, {skipped} skipped',
  'modal.cancel': 'Cancel', 'modal.confirm': 'Confirm', 'modal.deleteCourt': 'Delete Court',
  ...
  'pag.prev': 'Previous', 'pag.next': 'Next', 'pag.page': 'Page {page} of {total}', 'pag.showing': 'Showing {from}-{to} of {total}'
};

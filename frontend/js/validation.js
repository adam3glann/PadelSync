  ...
  name: [
    {
      required: true,
      getMessage: function () {
        return _vmsg("val.nameRequired");
      },
    },
    {
      minLength: 2,
      getMessage: function () {
        return _vmsg("val.nameMin");
      },
    },
    {
      pattern: /^[a-zA-Z\u0600-\u06FF\s]+$/,
      getMessage: function () {
        return _vmsg("val.namePattern");
      },
    },
  ],
  email: [
    {
      required: true,
      getMessage: function () {
        return _vmsg("val.emailRequired");
      },
    },
    {
      pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
      getMessage: function () {
        return _vmsg("val.emailInvalid");
      },
    },
  ],
  password: [
    {
      required: true,
      getMessage: function () {
        return _vmsg("val.passwordRequired");
      },
    },
    {
      minLength: 6,
      getMessage: function () {
        return _vmsg("val.passwordMin");
      },
    },
  ],
  confirmPassword: [
    {
      required: true,
      getMessage: function () {
        return _vmsg("val.confirmRequired");
      },
    },
  ],
  "court-name": [
    {
      required: true,
      getMessage: function () {
        return _vmsg("val.courtNameRequired");
      },
    },
    {
      minLength: 2,
      getMessage: function () {
        return _vmsg("val.courtNameMin");
      },
    },
    {
      maxLength: 30,
      getMessage: function () {
        return _vmsg("val.courtNameMax");
      },
    },
    {
      pattern: /^[a-zA-Z0-9\u0600-\u06FF\s\-]+$/,
      getMessage: function () {
        return _vmsg("val.courtNamePattern");
      },
    },
  ],
};

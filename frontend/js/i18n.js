var TEXT = {
  ...
  "hero.subtitle":
    "Reserve your padel court. Pre-order your gear. Walk in and smash it.",
  "hero.getStarted": "Get Started",
  "hero.login": "Login",
  "hero.goDashboard": "Go to Dashboard",
  "hero.feature1Title": "90-Min Blocks",
  "hero.feature1Desc":
    "Fixed time slots. No overflows, no surprises. You get the court for a full match window.",
  "hero.feature2Title": "Gear Ready",
  "hero.feature2Desc":
    "Order racquets and balls with your booking. Equipment prepared before you step on court.",
  "hero.feature3Title": "No Double Bookings",
  "hero.feature3Desc":
    "The schedule checks each court and time block before saving a booking.",
  ...
  "courts.price": "Price / 90 min (EGP)",
  "courts.discount": "Discount %",
  "courts.off": "off",
  "courts.editPrice": "Edit Price",
  "courts.bulkPricing": "Bulk Pricing",
  "courts.bulkPricingDesc":
    "Apply a new price and/or a discount to every court at once. Leave a field blank to leave that setting unchanged.",
  "courts.newPriceAll": "New price for all courts (EGP)",
  "courts.discountAll": "Discount % for all courts",
  "courts.applyToAll": "Apply to All Courts",
  ...
  "users.deleteAccountMsg":
    "Delete <strong>{name}</strong>'s account? Any courts they currently have booked will be freed up. This cannot be undone.",
  ...
  "val.priceInvalid": "Enter a valid price.",
  "val.discountInvalid": "Discount must be between 0 and 100.",
  "val.bulkPricingRequired": "Enter a price and/or a discount to apply.",
  ...
  "toast.bulkPriceApplied": "Pricing applied to all courts",
  "modal.deleteCourt": "Delete Court",
  "modal.deleteCourtMsg":
    "Delete <strong>{name}</strong> and all its time slots?",
...
Object.assign(TEXT, {
  ...
  "booking.policyText":
    "Pay 50% online to reserve your court. Pay the remaining 50% in cash at the court. Cancel more than 2 hours before your match for a full deposit refund, within 2 hours for a 25% refund, and after the match starts the deposit is not refunded.",
...
var AR = {
  ...
  "hero.feature1Desc":
    "مواعيد ثابتة بلا تجاوزات أو مفاجآت. الملعب لك لمباراة كاملة.",
  "hero.feature2Title": "المعدات جاهزة",
  "hero.feature2Desc":
    "اطلب المضارب والكرات مع حجزك لتكون جاهزة قبل دخولك الملعب.",
  ...
  "courts.price": "السعر / 90 دقيقة (جنيه)",
  "courts.discount": "نسبة الخصم %",
  "courts.off": "خصم",
  "courts.editPrice": "تعديل السعر",
  "courts.bulkPricing": "تسعير جماعي",
  "courts.bulkPricingDesc":
    "طبّق سعرًا جديدًا و/أو خصمًا على جميع الملاعب دفعة واحدة. اترك الحقل خاليًا لعدم تغيير هذه القيمة.",
  "courts.newPriceAll": "سعر جديد لجميع الملاعب (جنيه)",
  "courts.discountAll": "نسبة الخصم لجميع الملاعب",
  "courts.applyToAll": "تطبيق على جميع الملاعب",
  ...
  "users.deleteAccountMsg":
    "هل تريد حذف حساب <strong>{name}</strong>؟ سيتم إتاحة كل الملاعب التي حجزها. لا يمكن التراجع عن ذلك.",
  ...
  "val.priceInvalid": "أدخل سعرًا صحيحًا.",
  "val.discountInvalid": "يجب أن تكون نسبة الخصم بين 0 و 100.",
  "val.bulkPricingRequired": "أدخل سعرًا و/أو خصمًا لتطبيقه.",
  ...
  "toast.priceUpdated": "تم تحديث السعر",
  "toast.bulkPriceApplied": "تم تطبيق التسعير على جميع الملاعب",
  "modal.deleteCourt": "حذف الملعب",
  "modal.deleteCourtMsg":
    "هل تريد حذف <strong>{name}</strong> وكل فتراته الزمنية؟",
  ...
  "modal.cancelMemberMsg":
    "هل أنت متأكد من رغبتك في إلغاء هذا الحجز؟ سيتاح الموعد مجدداً.",
  "pag.prev": "السابق",
  "pag.next": "التالي",
...
Object.assign(AR, {
  ...
  "booking.policyText":
    "ادفع 50٪ عبر الإنترنت لحجز ملعبك، وادفع الـ50٪ المتبقية نقداً في الملعب. الإلغاء خلال ساعتين يتيح استرداد كامل العربون، وخلال 3 ساعات يتيح استرداد 25٪، وبعد 3 ساعات لا يُسترد العربون.",
...
function addLanguageButton() {
  ...
  button.setAttribute(
    "aria-label",
    getLang() === "ar" ? "Switch to English" : "التبديل إلى العربية",
  );
